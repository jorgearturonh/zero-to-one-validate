...
export const ideaIteratorPrompt = `
#Input
User idea
#Output
How to make the user idea more precise and well defined, recommendations on how to have a better more well defined startup idea, for example: ask for niches, type of app, type of product, etc.
`
